...
const Home = () => {
  ...
  return (
    <main className="bg-[#181818] w-full min-h-screen flex flex-col justify-between">
      <motion.div
        className="flex flex-col w-full h-full gap-2 text-gray-400 bg-[#181818]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="w-full h-full flex flex-col px-4 md:px-20">
          <span>
            <a href="/" className="text-4xl tracking-widest text-red-600 font-['terror']">
              PERPUS <br /> HORROR
            </a>
          </span>
          <Finder />
            ...
            {cerpen.map((item) => {
              return (
                <div
                  ...
                  key={item.id}
                >
                  <h1 className="text-xl font-['terror'] tracking-wide text-red-600">
                    {item.judul}
                  </h1>
